  ...
  run: [
    // windows nvidia
    {
      ...
      "params": {
        ...
        "message": "pip install torch==2.4.1 torchvision==0.19.1 torchaudio==2.4.1 {{args && args.xformers ? 'xformers' : ''}}  --index-url https://download.pytorch.org/whl/cu122"
      }
    },
    // windows amd
    {
    ...
    // linux nvidia
    {
      ...
      "params": {
        "venv": "{{args && args.venv ? args.venv : null}}",
        "path": "{{args && args.path ? args.path : '.'}}",
        "message": "pip install torch==2.4.1 torchvision==0.19.1 torchaudio==2.4.1 {{args && args.xformers ? 'xformers' : ''}}  --index-url https://download.pytorch.org/whl/cu123"
      }
    },
    // linux rocm (amd)
    {
